...
//   const KundliChartPainter({required this.config, this.planetImages});
...
//       final ui.Image? planetImage = planetImages?[_planetAssetKey(p.planet)];
//       if (planetImage != null) {
//         const double imageSize = 22;
...
//         final String symbolTop = p.planet.retrograde
//             ? '${p.planet.id}\u00AE'
//             : p.planet.id;
//         _paintText(
//           canvas,
//           symbolTop,
//           p.position + const Offset(0, -18),
//           TextStyle(
